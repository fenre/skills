...
usage() {
    cat <<EOF
Splunk Lookup File Editing Validation
...
cmd=(bash "${REPO_ROOT}/skills/shared/scripts/validate_render_first_skill.sh" --skill-name splunk-lookup-file-editing-setup --profile-dir splunk-lookup-file-editing --default-output splunk-lookup-file-editing-rendered --app-name lookup_editor)
