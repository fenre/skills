...
cmd=(bash "${REPO_ROOT}/skills/shared/scripts/validate_render_first_skill.sh" --skill-name splunk-pci-compliance-setup --profile-dir splunk-pci-compliance --default-output splunk-pci-compliance-rendered --app-name SplunkPCIComplianceSuite)
