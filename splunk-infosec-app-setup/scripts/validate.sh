...
cmd=(bash "${REPO_ROOT}/skills/shared/scripts/validate_render_first_skill.sh" --skill-name splunk-infosec-app-setup --profile-dir splunk-infosec-app --default-output splunk-infosec-app-rendered --app-name infosec_app_for_splunk)
